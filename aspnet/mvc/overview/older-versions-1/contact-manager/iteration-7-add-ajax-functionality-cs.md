...
[Code de téléchargement](iteration-7-add-ajax-functionality-cs/_static/contactmanager_7_cs1.zip)
...
[![Mise à jour uniquement des contacts](iteration-7-add-ajax-functionality-cs/_static/image1.jpg)](iteration-7-add-ajax-functionality-cs/_static/image1.png)

**Figure 01**: Mise à jour uniquement des contacts ([Cliquez pour voir l’image grandeur nature](iteration-7-add-ajax-functionality-cs/_static/image2.png))
...
**Liste 3 - Controllers-ContactController.cs (méthode de l’indice)**
...
**Figure 02**: La page de confirmation de suppression[(Cliquez pour voir l’image grandeur nature](iteration-7-add-ajax-functionality-cs/_static/image4.png))
...
> [Suivant précédent](iteration-6-use-test-driven-development-cs.md)
