...
[Code de téléchargement](iteration-4-make-the-application-loosely-coupled-cs/_static/contactmanager_4_cs1.zip)
...
**Liste 2 - Models-EntityContactManagerRepository.cs**
...
**Liste 4 - Models-ContactManagerService.cs**
...
**Liste 5 - Models-IContactManagerService.cs**
...
**Liste 7 - Models-Validation-ModelStateWrapper.cs**

[!code-csharp[Main](iteration-4-make-the-application-loosely-coupled-cs/samples/sample7.cs)]

**Liste 8 - Modèles-Validation-IValidationDictionary.cs**
...
> [Suivant précédent](iteration-3-add-form-validation-cs.md)
