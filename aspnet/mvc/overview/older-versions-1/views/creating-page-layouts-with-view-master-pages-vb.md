...
title: Création de mises en page avec Afficher les pages Maîtresses (VB) Microsoft Docs
...
[Télécharger le PDF](https://download.microsoft.com/download/e/f/3/ef3f2ff6-7424-48f7-bdaa-180ef64c3490/ASPNET_MVC_Tutorial_12_VB.pdf)
...
[![Ajout d’une page maîtresse de vue](creating-page-layouts-with-view-master-pages-vb/_static/image2.png)](creating-page-layouts-with-view-master-pages-vb/_static/image1.png)

**Figure 01**: Ajout d’une page maîtresse de vue[(Cliquez pour voir l’image grandeur nature](creating-page-layouts-with-view-master-pages-vb/_static/image3.png))
...
[![Aperçu d’une page maîtresse dans le concepteur](creating-page-layouts-with-view-master-pages-vb/_static/image5.png)](creating-page-layouts-with-view-master-pages-vb/_static/image4.png)

**Figure 02**: Aperçu d’une page maîtresse dans le concepteur ([Cliquez pour voir l’image grandeur nature](creating-page-layouts-with-view-master-pages-vb/_static/image6.png))
...
**Figure 03**: Ajout d’une page de contenu de vue[(Cliquez pour voir l’image grandeur nature](creating-page-layouts-with-view-master-pages-vb/_static/image9.png))
...
[![Sélection d’une page maîtresse](creating-page-layouts-with-view-master-pages-vb/_static/image11.png)](creating-page-layouts-with-view-master-pages-vb/_static/image10.png)

**Figure 04**: Sélection d’une page maîtresse ([Cliquez pour voir l’image grandeur nature](creating-page-layouts-with-view-master-pages-vb/_static/image12.png))
...
[![La page de contenu de l’index](creating-page-layouts-with-view-master-pages-vb/_static/image14.png)](creating-page-layouts-with-view-master-pages-vb/_static/image13.png)

**Figure 05**: La page de contenu de l’index[(Cliquez pour voir l’image grandeur nature](creating-page-layouts-with-view-master-pages-vb/_static/image15.png))
...
> [Suivant précédent](using-the-tagbuilder-class-to-build-html-helpers-vb.md)
