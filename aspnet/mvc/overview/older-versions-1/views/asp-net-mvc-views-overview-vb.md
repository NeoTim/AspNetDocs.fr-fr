...
Vous pouvez utiliser n’importe quel langage .NET pour générer du contenu dynamique dans une vue. Normalement, vous utiliserez Visual Basic .NET ou C# pour écrire vos contrôleurs et vos vues.
...
[![Boîte de dialogue New Project](asp-net-mvc-views-overview-vb/_static/image1.jpg)](asp-net-mvc-views-overview-vb/_static/image1.png)
