...
Vous trouverez ci-dessous le code JavaScript que nous ajouterons au fichier Map.js qui interagit avec Virtual Earth pour afficher notre carte et y ajouter des codes confidentiels pour nos dîners :
