...
**Figure 1**: Ajout d’une référence au modèle d’annotations de données Binder[(Cliquez pour voir l’image grandeur nature](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
Cette ligne de code enregistre l’ataAnnotationsModelBinder comme le liant de modèle par défaut pour l’ensemble de l’application ASP.NET MVC.
...
**Figure 6**: Utilisation de validateurs avec le cadre de l’entité ([Cliquez pour voir l’image grandeur nature](validation-with-the-data-annotation-validators-cs/_static/image14.png))
...
> [Suivant précédent](validating-with-a-service-layer-cs.md)
