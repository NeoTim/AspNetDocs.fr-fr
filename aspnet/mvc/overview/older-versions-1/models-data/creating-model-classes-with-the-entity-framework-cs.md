...
title: Création de classes modèles avec le Cadre d’entités (C) Microsoft Docs
...
Afin d’utiliser la classeMoviesDBEntities dans le contrôleur à domicile, vous devez importer le namespace MovieEntityApp.Models (*MVCProjectName*. Modèles).
...
La vue dans Listing 2 contient une boucle **de foreach** qui itère à travers chaque album de film et affiche les valeurs des propriétés titre et réalisateur de l’enregistrement du film. Notez qu’un lien Edit and Delete s’affiche à côté de chaque enregistrement. De plus, un lien Add Movie apparaît au bas de la vue (voir la figure 7).

**Figure 7 - La vue de l’indice**

![clip_image014](creating-model-classes-with-the-entity-framework-cs/_static/image7.jpg)

La vue index est une *vue dactylographe*. La vue index &lt;comprend une&gt; directive de % avec un attribut *d’héritage qui* jette la propriété&lt;modèle à une collection de listes génériques fortement tapées d’objets de film (List Movie).
...
**Liste 3 - Controllers-HomeController.cs (Méthodes d’ajout)**
...
**Liste 4 - Controllers-HomeController.cs (Méthodes d’édition)**
...
**Liste 6 -- 'Controllers’HomeController.cs (Supprimer l’action)**
